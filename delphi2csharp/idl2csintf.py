...
def writeObjNewers(interface):
    ...
    outfile.write('        {\n')
    outfile.write('            var obj = InteropContainer.Default.Resolve<I%s>();\n' % (interface.name))
...
def printMod(module):
    ...
    # todo: registertype shouldn't be autogenerated
    outfile.write('            InteropContainer.Default.RegisterType<ICommunicator, Communicator>();\n')
