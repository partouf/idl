...
def writeInitializeDLL(module):
    outfile.write('procedure InitializeDLL;\n')
    outfile.write('begin\n')
...
def writeFinalizeDLL(module):
    ...
    outfile.write('procedure FinalizeDLL;\n')
    outfile.write('begin\n')
    outfile.write('  if %s = 0 then Exit;\n\n' % dllHandleVarname)
...
def printMod(module):
    ...
    outfile.write('initialization\n')
    outfile.write('  InitializeDLL;\n')
    outfile.write('finalization\n')
    outfile.write('  FinalizeDLL;\n')
    outfile.write('end.\n')
    outfile.close()
